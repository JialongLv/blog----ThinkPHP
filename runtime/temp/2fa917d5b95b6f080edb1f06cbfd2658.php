<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"C:\wamp64\www\blog\public/../application/index\view\lst\lst.html";i:1491663242;s:69:"C:\wamp64\www\blog\public/../application/index\view\Public\right.html";i:1491530157;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="col-md-9">
                   ...
                   <div class="blog-main">
                        ...
                        <div class="heading-blog">
                            <h2 ><a hef="<?php echo url('Article/index',array('artid'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a></h2>
                        </div>
                        ...
                        <div class="blog-info">
                            ...
                            <span class="label label-success">栏目：<?php echo $catename; ?>  </span>
                           
                                 
                           
                            <span class="label label-info">
                              点击： <?php echo $vo['click']; ?>
                            </span>
