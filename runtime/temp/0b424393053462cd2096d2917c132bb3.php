<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"C:\wamp64\www\blog\public/../application/admin\view\guest\lst.html";i:1490972219;s:67:"C:\wamp64\www\blog\public/../application/admin\view\Public\top.html";i:1490272337;s:68:"C:\wamp64\www\blog\public/../application/admin\view\Public\left.html";i:1490971917;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td title="<?php echo $vo['nickname']; ?>"><a target="_blank" href="#" title="<?php echo $vo['title']; ?>"><?php echo $vo['nickname']; ?></a>
                            </td>
                           
                            <td><?php echo $vo['book']; ?></td>
                            <td><?php echo date("Y-m-d",$vo['createtime']); ?></td>
                            <td>
                                <a class="link-update" href="<?php echo url('guest/add',array('id'=>$vo['id'])); ?>">发布</a>
                                <a class="link-update" href="<?php echo url('guest/reply',array('id'=>$vo['id'])); ?>">回复</a>
                                <a class="link-del" onclick="return confirm('你确定要删除该管理员吗？');" href="<?php echo url('guest/del',array('id'=>$vo['id'])); ?>">删除</a>
                            </td>
                        </tr>
                       <?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                    <div class="list-page"><?php echo $books->render(); ?></div> 
                </div>
            </form>
        </div>
    </div>
