<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"C:\wamp64\www\blog\public/../application/admin\view\admin\edit.html";i:1490272469;s:67:"C:\wamp64\www\blog\public/../application/admin\view\Public\top.html";i:1490272337;s:68:"C:\wamp64\www\blog\public/../application/admin\view\Public\left.html";i:1490192170;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="username" size="50" value="<?php echo $admins['username']; ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>密码：</th>
                                <td><input class="common-text" name="password" size="50" value="" type="text">留空则表示不修改密码</td>
                            </tr>
                             <tr>
                                <th></th>
                                <td>
