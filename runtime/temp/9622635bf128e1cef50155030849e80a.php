<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"C:\wamp64\www\blog\public/../application/admin\view\link\lst.html";i:1489668198;s:67:"C:\wamp64\www\blog\public/../application/admin\view\Public\top.html";i:1490272337;s:68:"C:\wamp64\www\blog\public/../application/admin\view\Public\left.html";i:1490192170;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <script type="text/javascript" src="__PUBLIC__/static/adminjs/libs/modernizr.min.js"></script>
    <style type="text/css">
        ul.pagination li{
            float: left;
        }
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td title="<?php echo $vo['title']; ?>"><a target="_blank" href="<?php echo $vo['url']; ?>" title="<?php echo $vo['title']; ?>"><?php echo $vo['url']; ?></a></td>
                            <td>
                                <a class="link-update" href="<?php echo url('edit',array('id'=>$vo['id'])); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('你确定要删除该链接吗？');" href="<?php echo url('del',array('id'=>$vo['id'])); ?>">删除</a>
                            </td>
                        </tr> 
                         <?php endforeach; endif; else: echo "" ;endif; ?>    
                    </table>
                    <div class="list-page"><?php echo $linkres->render(); ?></div>
                </div>
            </form>
        </div>
    </div>
